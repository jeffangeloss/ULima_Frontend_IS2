...
| **Chat de sección** | [`.../chat.spec.md`](specs/features/chat/chat.spec.md) · 651 líneas · RF-CHAT-1 a RF-CHAT-13 | HU23 | `chat_page`, `chats_inbox_page`, botón de la ficha, tarjeta de Secciones | `ChatRepository`, `NetworkingService` | `HU23_jeff` (167, 9 archivos) | Fase 1 en el código y sin cerrar. Faltan el ajuste del footer del delegado (RF-CHAT-5), la revisión manual que pide «Verificación» en un iPhone SE, en claro y en oscuro, del footer del delegado, de la bandeja y de la conversación, y la aprobación de los ajustes de app-shell, schedule y course-detail |
