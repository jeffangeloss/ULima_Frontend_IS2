...
| **Chat de sección** | [`.../chat.spec.md`](specs/features/chat/chat.spec.md) · 651 líneas · RF-CHAT-1 a RF-CHAT-13 | HU23 | `chat_page`, `chats_inbox_page`, botón de la ficha, tarjeta de Secciones | `ChatRepository`, `NetworkingService` | `HU23_jeff` (167, 9 archivos) | Fase 1 implementada el 2026-09-23; falta la revisión manual en un iPhone SE del footer del delegado |
...
| **HU23** | Chat en vivo por sección | Alumno / Docente | `lib/pages/chat/**` | jeff | 167 | Implementado, con la pestaña Chats de la fase 1; reglas RTDB pendientes de validar con Emulator |
