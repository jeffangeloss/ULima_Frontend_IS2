...
| 16 | Registro de alumno | `specs/features/registro/registro.spec.md` | HU-REG-01, HU-REG-02 | Alta de cuenta contra miUlima en dos pasos; el portal certifica la matrícula y entrega los datos | `lib/pages/registro/**`, `lib/services/registro_service.dart` | **Diseñada — pendiente de implementación** |
