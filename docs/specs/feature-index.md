...
| 20 | Truco del 67 | `specs/features/six-seven/six-seven.spec.md` | HU-67-01, HU-67-02 | RF-67-1 a RF-67-7. Un mensaje que es solo un 67 inclina la interfaz del chat unos 2 s y muestra «SIX SEVEN!!!», como burbuja local de Ulises en el chatbot, sin llamar al backend, y como rótulo pasajero en los chats de sección, solo con los mensajes que llegan en vivo | `lib/domain/seis_siete/seis_siete.dart`, `lib/components/seis_siete/tambaleo_seis_siete.dart`, `lib/pages/chat/chat_seis_siete.dart`, `lib/pages/chat/chat_page.dart`, `lib/pages/chatbot/chatbot_controller.dart`, `lib/pages/chatbot/chatbot_page.dart` | Aprobada por el dueño el 2026-09-25, con P1 a P4 y D1 a D15 en su valor por defecto salvo D4, donde elige «toda la pantalla», así que se inclina todo el chat, también el AppBar, y en el chat de Ulises en pantalla ancha solo el panel del chat con su tramo de barra. Pendiente de implementación. Ajusta de paso RF-CHAT-2 (el stream del chat de sección se crea una vez por página) y la entrada de preguntas del chatbot |
