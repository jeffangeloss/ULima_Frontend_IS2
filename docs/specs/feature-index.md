...
| 20 | Truco del 67 | `specs/features/six-seven/six-seven.spec.md` | HU-67-01, HU-67-02 | RF-67-1 a RF-67-7. Un mensaje que es solo un 67 inclina la interfaz del chat unos 2 s y muestra «SIX SEVEN!!!», como burbuja local de Ulises en el chatbot, sin llamar al backend, y como rótulo pasajero en los chats de sección, solo con los mensajes que llegan en vivo | `lib/domain/seis_siete/seis_siete.dart`, `lib/components/seis_siete/tambaleo_seis_siete.dart`, `lib/pages/chat/chat_seis_siete.dart`, `lib/pages/chat/chat_page.dart`, `lib/pages/chatbot/chatbot_controller.dart`, `lib/pages/chatbot/chatbot_page.dart` | Diseñada el 2026-09-25 a partir de las decisiones del dueño; pendiente de su aprobación, con las propuestas P1 a P4 y los puntos D1 a D14 a la vista. Ajusta de paso RF-CHAT-2 (el stream del chat de sección se crea una vez por página) y la entrada de preguntas del chatbot |
